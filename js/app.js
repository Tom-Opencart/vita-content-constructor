...
var CC_SCHEMA_SPEC = {
	...
	supported_blocks: [
		...
		{ type: 'hero', data_schema: { title: 'String (markdown, H1)', sub: 'String (markdown)', btn1_label: 'String', btn1_url: 'String (или form:ID)', btn2_label: 'String', btn2_url: 'String', note: 'String — строка доверия', align: 'left|center', visual: 'none|metrics — панель-визуал справа (референс hero-visual)', visual_kicker: 'String', visual_path: 'String', visual_metrics: 'Array of { value, label }', sec: 'Object — общие поля секции' } },
